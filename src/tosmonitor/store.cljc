(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (BASF SE, LEI
  529900PM64WH8AF1E917) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Disclaimer\nThis website is published by BASF SE, a German chemicals company headquartered in Ludwigshafen am Rhein. The content is provided for general informational purposes only and is subject to change without notice. Access to and use of this website are governed exclusively by the laws of the Federal Republic of Germany.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.basf.com/jp/en/legal/disclaimer.html"
