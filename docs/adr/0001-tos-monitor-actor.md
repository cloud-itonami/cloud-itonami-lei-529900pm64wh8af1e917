...
- Related: [`com-junkawasaki/root` ADR-2607110300](https://github.com/com-junkawasaki/root/blob/main/90-docs/adr/2607110300-cloud-itonami-lei-corporate-tos-catalog.edn)
  ...
  (the 10-repo validation batch this repo is part of, round 5).

## Context

This repository archives the publicly published Terms of Use of
BASF SE, per ADR-2607110300 -- a read-only reference archive. As part of a
10-repo validation batch extending the `cloud-itonami-lei-2572ibtt8cczw6au4141`
pilot (see ADR-2607241900/ADR-2607242600 for the full fleet-level design
...
- **Company**: BASF SE, LEI 529900PM64WH8AF1E917, website
  `https://www.basf.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.basf.com/jp/en/legal/disclaimer.html`,
